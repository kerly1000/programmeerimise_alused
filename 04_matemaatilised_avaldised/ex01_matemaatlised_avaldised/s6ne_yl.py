"""1. Loo muutuja first_name, mille väärtus on "James", ja last_name, mille väärtus on "Bond
2. Loo muutuja full_name, mille väärtuseks on sõne järgmisel kujul: "first_name last_name", kus first_name ja last_name
on eelmises ülesandes loodud muutujate väärtused. Kasuta selleks sõnede liitmist.
3. Loo muutuja self_description_sentence, mille väärtus on sõne järgmisel kujul: "My name is last_name, first_name
last_name.", kus first_name ja last_name on eelmises ülesandes loodud muutujate väärtused. Sõne kujundamiseks kasuta
f stringi."
4. Loo muutuja cake = "vahukoormarjadtäidispõhi".
...
5. Harjutame sõnede tükeldamist ehk slice notation'i kasutamist.
...
first_word_reversed = original_string[12:0 -1:-1]
